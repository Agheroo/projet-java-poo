...
/*
 * This class's purpose is to set and keep track of everything in the game despite its display on the screen
 *
 *
 */
public class World extends Scene {
    ...
    public void update() {
        ...
        // Checks if the player is touching the edges of the map
        if (player.worldX < 0) {
            player.worldX = 0;
        }
